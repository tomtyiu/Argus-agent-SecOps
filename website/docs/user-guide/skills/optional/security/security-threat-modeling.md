---
title: "Threat Modeling — Use when modeling threats for a system or feature."
...
Use when modeling threats for a system or feature.

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `hermes skills install official/security/threat-modeling` |
| Path | `optional-skills/security/threat-modeling` |
| Version | `0.1.0` |
